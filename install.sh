...
echo ""
echo "⚠️  Artemis II splashes down ~April 11. Run uninstall.sh once Orion is back on Earth:"
echo "   curl -fsSL https://raw.githubusercontent.com/PatrickRoyMac/artemis_cc_tracking/main/uninstall.sh | bash"
echo ""
